...
import {
  ...
  ChevronLeft, LayoutDashboard, User, Warehouse, ClipboardList, Users, QrCode, CircleUser, Calculator, Truck,
} from "lucide-react";
...
const adminNav: Array<{ label: string; href: string; icon: typeof Package; permission: Permission }> = [
  ...
  { label: "Suppliers", href: "/admin/suppliers", icon: Truck, permission: "warehouse:manage" },
