...
ALTER TABLE `online_store_return_items` ADD CONSTRAINT `return_items_order_item_id_order_items_id_fk` FOREIGN KEY (`order_item_id`) REFERENCES `online_store_order_items`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
